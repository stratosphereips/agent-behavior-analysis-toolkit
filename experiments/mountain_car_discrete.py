...
if __name__ == "__main__":
    ...
    # MountainCar often requires more episodes to solve
    parser.add_argument("--episodes", default=10000, type=int, help="Number of training episodes")
    parser.add_argument("--evaluate_each", default=1000, type=int, help="Periodic evluation frequency")
    parser.add_argument("--evaluate_for", default=250, type=int, help="Periodic evluation length")
    ...
    # Tuned/Default values for MountainCar
    AGENT_CONFIGS = {
        "ppo": {
            "lr": 3e-4,
            "gamma": 0.99,
        ...
        "dqn": {
            ...
            "epsilon": 1.0,
            "epsilon_min": 0.01,
            "epsilon_decay": 0.9995, # Slower decay for MC
            "batch_size": 64,
        ...
        "sarsa": {
            "alpha": 0.1, # Initial alpha, maybe 0.2? adhering to successful MC defaults
            "gamma": 0.99,
            "epsilon": 1.0,
            "epsilon_min": 0.01,
            "epsilon_decay": 0.9999 # Very slow decay needed usually? or 0.9995
        },
        "q_learning": {
             "alpha": 0.1,
             "gamma": 0.99,
