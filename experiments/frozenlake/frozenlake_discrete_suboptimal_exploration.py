...
if __name__ == "__main__":
    ...
    # Suboptimal exploration parameters
    parser.add_argument("--epsilon_decay", default=0.95, type=float, help="Epsilon decay rate (suboptimal: fast decay)")
    parser.add_argument("--min_epsilon", default=0.001, type=float, help="Minimum epsilon (suboptimal: almost no residual exploration)")
    parser.add_argument("--epsilon", default=1.0, type=float, help="Initial epsilon (suboptimal: low initial)")
    parser.add_argument("--entropy_coef", default=0.0, type=float, help="Entropy coefficient for PPO (suboptimal: 0.0)")
    ...
    parser.add_argument("--q_init_val", default=0.0, type=float, help="Initial value for Q-table (suboptimal: 0.0)")
