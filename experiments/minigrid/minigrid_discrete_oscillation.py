...
if __name__ == "__main__":
    ...
    parser.add_argument("--alpha", default=1.1, type=float, help="Learning rate (tabular)")
    parser.add_argument("--lr", default=0.01, type=float, help="Learning rate (NN)")
    ...
    # Oscillation NN Hyperparameters
    parser.add_argument("--batch_size", default=8, type=int, help="Batch size")
    parser.add_argument("--target_update_every", default=1, type=int, help="DQN target switch freq")
    parser.add_argument("--train_iters", default=40, type=int, help="PPO train epochs")
    parser.add_argument("--clip_ratio", default=0.8, type=float, help="PPO clip length")
    ...
    print("Running OSCILLATION MiniGrid with config:")
    ...
    if args.model in ["q_learning", "sarsa"]:
        ...
        relevant_keys = common_keys + ["gamma", "lr", "clip_ratio", "entropy_coef", "train_iters"]
    else:
